...
if __name__ == '__main__':
    ...
    input_path = os.getenv('INPUT_PATH2')
    output_path = os.getenv('OUTPUT_PATH2')
    ...
    name_list = {
        ...
        'min_cluster_size': [10],
        'operator': '>=',
        'timestamp_pattern': 'sbmn_cappi_%Y%m%d_%H%M.nc.gz',
        'delta_time': 12,
        ...
        # Forecast parameters
        'last_timestamp': '2014-08-16 18:12',
        'horizon_forecast': 10,
    ...
    try:
        # Generate forecasts
        pyfortracc.track(name_list, read_radar_data)
        forecast_frames = persistence_forecast(name_list, read_radar_data)
